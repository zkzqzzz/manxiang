	...
	public static class Builder {
		...
		public CustomDialog create() {
			...
			if (message != null) {
				...
				LinearLayout message = (LinearLayout) layout.findViewById(R.id.message);
				message.removeAllViews();
				message.addView(contentView, new LayoutParams(LayoutParams.WRAP_CONTENT, LayoutParams.WRAP_CONTENT));
