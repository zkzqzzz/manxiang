...
public class BrowseStickyNavLayout extends LinearLayout {
    ...
    public BrowseStickyNavLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    protected void onFinishInflate() {
        ...
        mNav = findViewById(R.id.browse_tabs);
        mViewPager = (ViewPager) findViewById(R.id.browse_pager);
    }
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        mTopViewHeight = LengthUnitUtils.dp2px(getContext(),461);
    }
