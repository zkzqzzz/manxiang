...
import com.demo.zk.manxiang.utils.DensityUtil;
...
//			0xcfE9E9E9, 0x3fE9E9E9 };
    ...
    private void drawCenterRect(Canvas canvas) {
        ...
        paint.setColor(getResources().getColor(R.color.wg_liner));
        // 设置线宽
    ...
    private View getItemView(int index) {
        ...
        index %= count;
        View item = viewAdapter.getItem(index, recycle.getItem(), itemsLayout);
        item.setPadding(0, DensityUtil.dip2px(getContext(), 12), 0, DensityUtil.dip2px(getContext(), 12));
        return item;
    }
